...
function Cart() {
  ...
  const { totalPrice, itemsCount, items } = useSelector(({ cart }) => {
    return cart
  })

  const addedPizzas = Object.keys(items).map(item => {
          ...
          : <div className="cart">
                ...
                addedPizzas.map(obj => {
                  return (
                    <CartItem
                      ...
                      size={obj.size}
                      id={obj.id}
                      totalPizzaPrice={items[obj.id].totalPrice}
                      itemsPizzaCount={items[obj.id].items.length}
            ...
            <div className="cart__bottom">
              ...
              <div className="cart__bottom-buttons">
                ...
                <Button onClick={onCartOrder} className="pay-btn">
